defmodule Calculator do
  @moduledoc """
  Define Calculator module and functions to execute it.
  """
  ...
  """
  def start()do
    joao = %Studant{name: "Joao Joaquim", results: build_subjects([5.2,3.9,2.7,9.8])}
    maria = %Student{name: "Maria da Silva", results: build_subjects([8.4, 7.5, 9.4, 2.8])}
    pedro = %Studant{name: "Pedro Pedrada", results: build_subjects([1.3,8.5,8.9,7.6])}
    kaua = %Studant{name: "Kaua Camboinhas", results: build_subjects([5.4,4.9,2.2,3.8])}
  ...
  @doc """
  Get all studantes with their avenrages.
